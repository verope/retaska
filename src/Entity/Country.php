...
class Country
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\PurchaseOrder", mappedBy="country")
     */
    ...
    public function removePurchaseOrder(PurchaseOrder $purchaseOrder): self
    {
        if ($this->purchaseOrders->contains($purchaseOrder)) {
            ...
            if ($purchaseOrder->getCountry() === $this) {
                $purchaseOrder->setCountry(null);
            }
        }
